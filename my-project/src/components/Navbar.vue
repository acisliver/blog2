<template>
  <b-navbar style="display: flex; justify-content: space-between">
    <template slot="brand">
      <b-navbar-item tag="router-link" :to="{ path: '/' }" style="font-size: 30px; color: #FFC045">
        <svg style="width:30px;height:30px; margin-right: 5px;" viewBox="0 0 24 24">
